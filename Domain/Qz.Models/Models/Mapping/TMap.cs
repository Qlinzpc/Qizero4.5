...
{
    public class TMap : EntityTypeConfiguration<T>
    {
        public TMap()
        {
            // Primary Key
            ...
            this.Property(t => t.SourceDatabaseID).HasColumnName("SourceDatabaseID");
            this.Property(t => t.BigintData1).HasColumnName("BigintData1");
            this.Property(t => t.Mode).HasColumnName("Mode");
            this.Property(t => t.ObjectID2).HasColumnName("ObjectID2");
