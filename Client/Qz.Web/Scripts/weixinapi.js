    ...
    document.querySelector('#chooseImage').onclick = function () {
        ...
        wx.chooseImage({
            success: function (res) {
                ...
                $api.after($this, '<img id="img1" src="" /><img id="img" src="' + images.localId + '" />');
                var url = images.localId;
                convertImgToBase64(url, function (d) {
                    alert(d);
        ...
        function download() {
            wx.downloadImage({
                ...
                success: function (res) {
                    ...
                    i++;
                    alert('已下载：' + i + '/' + length + " " + JSON.stringify(res));
                    images.localId.push(res.localId);
                    if (i < length) {
                        download();
                    }

                    var ajax = { url: "/Common/Download", data: { media: images.serverId } };
                    common.tip(ajax);
                    common.ajax.post({
                        url: ajax.url,
                        data: ajax.data,
